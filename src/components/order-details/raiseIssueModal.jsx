...
const IssueForm = ({
  ...
  const checkImages = () => {
    if (['ITM02', 'ITM03', 'ITM04', 'ITM05', 'FLM04'].includes(selectedIssueSubcategory?.enums) && baseImage.length <= 0) {
      setInlineError(prev => ({
        ...prev,
  ...
  return (
    ...
    >
      <DialogTitle sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h6">Raise an Issue</Typography>
      ...
      <DialogContent>
        <Stack spacing={3} sx={{ mt: 2 }}>
          {/* Item Selection */}
          <Box>
            <Typography variant="subtitle1" color="primary" gutterBottom required>
            ...
            {partailsIssueProductList.map((product, index) => (
              ...
              >
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <Typography variant="subtitle2">₹ {Number(product?.price?.value)?.toFixed(2)}</Typography>
                </Box>
              </Paper>
            ))}
        ...
        >
          ...
          <Box>
            <Typography variant="subtitle2" gutterBottom>
              Images (Maximum 4) {['ITM02', 'ITM03', 'ITM04', 'ITM05', 'FLM04'].includes(selectedIssueSubcategory?.enums) && '*'}
            </Typography>
            <Button
              variant="outlined"
              component="label"
              ...
              {baseImage.map((image, index) => (
                ...
                >
                  <IconButton
                    ...
                    onClick={() => setBaseImage(baseImage.filter((_, i) => i !== index))}
                  >
