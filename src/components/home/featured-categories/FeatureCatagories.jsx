...
const areEqual = (prevProps, nextProps) => {
    // Component doesn't have props, but we can check if state affecting it changed
    // If needed, add specific comparisons here
    return true;
};

export default memo(FeatureCatagories, areEqual);